...
while($data = mysqli_fetch_assoc($fet)){
    ?>
                        ...
                        <tr>
                            ...
                            <td> <img style="width:100px" src="images/<?php echo $data["product_image"] ?>" alt="">
                            </td>
                            <td> <?php echo $data["category_name"] ?> </td>
                            <td> <?php echo $data["brand_name"] ?> </td>
                            <td>
                                <a class="btn btn-warning"
                                    href="updateProduct.php?id=<?php echo $data["product_id"] ?>"> Edit </a>
                                <a class="btn btn-danger" href="deleteProduct.php?id=<?php echo $data["product_id"] ?>"
