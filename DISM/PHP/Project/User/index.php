        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    ...
                    <?php while($data = mysqli_fetch_assoc($fet)){ ?>
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-item">
                                <div class="position-relative bg-light overflow-hidden">
                                    <img class="w-100" height="200px" src="../Admin/images/<?php echo $data["product_image"] ?>" alt="">
                                    <div class="bg-secondary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">New</div>
                                </div>
                                <div class="text-center p-4">
                                    <a class="d-block h5 mb-2" href=""><?php echo $data["product_name"] ?></a>
                                    <span class="text-primary me-1"><?php echo $data["product_price"] ?></span>
                                    <span class="text-body text-decoration-line-through">$29.00</span>
                                </div>
                                <div class="d-flex border-top">
                                    <small class="w-50 text-center border-end py-2">
                                        <a class="text-body" href="productDetails.php?id=<?php echo $data["product_id"] ?>"><i class="fa fa-eye text-primary me-2"></i>View detail</a>
                                    </small>
